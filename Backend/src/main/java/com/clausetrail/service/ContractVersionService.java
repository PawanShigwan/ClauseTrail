...
public class ContractVersionService {
    ...
    public ContractResponse submitModification(String contractId, ModifyContractRequest request, String ipAddress) {
        ...
        int maxExisting = contractVersionRepository.findFirstByContractIdOrderByVersionNumberDesc(contractId)
                .map(ContractVersion::getVersionNumber)
                .orElse(contract.getCurrentVersionNumber());
        int newVersionNumber = maxExisting + 1;
