...
public class NotificationResponse {
    ...
    public NotificationResponse(String id, String userId, String title, String message, NotificationType type, String contractId, String contractTitle, Integer versionNumber, boolean read, Instant createdAt) {
        this.id = id;
        this.userId = userId;
        this.title = title;
    ...
    public static class Builder {
        ...
        public NotificationResponse build() {
            return new NotificationResponse(id, userId, title, message, type, contractId, contractTitle, versionNumber, read, createdAt);
        }
    }
