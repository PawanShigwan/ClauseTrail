...
public class ClauseChangeDTO {
    ...
    public ClauseChangeDTO(String clauseId, String clauseNumber, String clauseTitle, String previousText, String modifiedText, ChangeType changeType) {
    ...
    public static class Builder {
        ...
        public ClauseChangeDTO build() {
            return new ClauseChangeDTO(clauseId, clauseNumber, clauseTitle, previousText, modifiedText, changeType);
        }
    }
