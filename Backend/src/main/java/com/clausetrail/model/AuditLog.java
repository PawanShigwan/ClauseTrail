...
public class AuditLog {
    ...
    public AuditLog(String id, String contractId, String contractTitle, String userId, String userName, Role userRole, AuditAction action, String details, Integer versionNumber, String ipAddress, Instant timestamp) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public AuditLog build() {
            return new AuditLog(id, contractId, contractTitle, userId, userName, userRole, action, details, versionNumber, ipAddress, timestamp);
        }
    }
