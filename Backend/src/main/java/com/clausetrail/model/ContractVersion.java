...
@CompoundIndex(name = "contract_version_idx", def = "{'contractId': 1, 'versionNumber': 1}", unique = true)
public class ContractVersion {
    ...
    public static class Builder {
        ...
        public ContractVersion build() {
            return new ContractVersion(id, contractId, versionNumber, fullText, clauses, clauseChanges, modifiedBy, modificationReason, status, reviewedBy, reviewComments, reviewedAt, parentVersionId, parentVersionNumber, createdAt);
        }
    }
