...
public class Clause {
    ...
    public Clause(String id, int orderIndex, String clauseNumber, String title, String content, String category) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public Clause build() {
            return new Clause(id, orderIndex, clauseNumber, title, content, category);
        }
    }
